 ...
 * 触发词: @Domiclaw
 */
export const ASSISTANT_NAME = process.env.ASSISTANT_NAME || envConfig.ASSISTANT_NAME || "Domiclaw";
/**
 * 消息轮询间隔（毫秒）
 *
 * 每次检查新消息的间隔时间
 ...
 * 默认: deepseek-chat
 */
export const MODEL_NAME = process.env.MODEL_NAME || envConfig.MODEL_NAME || "deepseek-chat";
/**
 * 模型 API 基础 URL
 *
 * 用于调用模型服务的地址
 ...
 * 无默认值，需要在 .env 中配置
 */
export const MODEL_API_KEY = process.env.MODEL_API_KEY || envConfig.MODEL_API_KEY || "";
/**
 * 单次最多处理的消息数
 *
 * 一次 API 调用中发送的最大消息数
